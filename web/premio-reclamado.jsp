    ...
    <body id="cuerpo">
        ...
        <div class="block" id="blockrc">
            <div class="card-panel">
                <div class="row">
                    <div class="col s10">
                        <p style="font-size: 30px" id="titleis">¡Premio Reclamado!</p>
                        <br>
                        <p style="font-size: 15px" id="subtitleis">Has reclamado tu premio de manera exitosa, pronto te contactaremos para efectuar el proceso.</p><br>
                    </div>
                    <div class="col s1">
